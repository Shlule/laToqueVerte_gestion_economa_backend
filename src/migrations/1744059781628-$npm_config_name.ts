...
export class  $npmConfigName1744059781628 implements MigrationInterface {
    name = ' $npmConfigName1744059781628'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "recipe" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "quantity" numeric(10,2), "unitType" "public"."recipe_unittype_enum" NOT NULL DEFAULT 'unit', "cost" numeric(10,2), CONSTRAINT "PK_e365a2fedf57238d970e07825ca" PRIMARY KEY ("id"))`);
