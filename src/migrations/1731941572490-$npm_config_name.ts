...
export class  $npmConfigName1731941572490 implements MigrationInterface {
    name = ' $npmConfigName1731941572490'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "recipe" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "isPossible" boolean NOT NULL DEFAULT false, "cost" numeric(10,2) NOT NULL, CONSTRAINT "PK_e365a2fedf57238d970e07825ca" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."recipe_ingredient_unit_enum" AS ENUM('kg', 'g', 'unit')`);
        await queryRunner.query(`CREATE TABLE "recipe_ingredient" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantityNeeded" numeric(10,2) NOT NULL, "unit" "public"."recipe_ingredient_unit_enum" NOT NULL DEFAULT 'unit', "recipeId" uuid, "ingredientId" uuid, CONSTRAINT "PK_a13ac3f2cebdd703ac557c5377c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."ingredient_unittype_enum" AS ENUM('kg', 'g', 'unit')`);
        await queryRunner.query(`CREATE TABLE "ingredient" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "pricePerUnit" numeric(10,2) NOT NULL, "unitType" "public"."ingredient_unittype_enum" NOT NULL DEFAULT 'unit', CONSTRAINT "PK_6f1e945604a0b59f56a57570e98" PRIMARY KEY ("id"))`);
