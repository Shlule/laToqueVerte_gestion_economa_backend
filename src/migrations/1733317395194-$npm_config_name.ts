...
export class  $npmConfigName1733317395194 implements MigrationInterface {
    name = ' $npmConfigName1733317395194'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "recipe" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "insufficientIngredient" jsonb, "numberOfPieces" integer NOT NULL, "cost" numeric(10,2), CONSTRAINT "PK_e365a2fedf57238d970e07825ca" PRIMARY KEY ("id"))`);
